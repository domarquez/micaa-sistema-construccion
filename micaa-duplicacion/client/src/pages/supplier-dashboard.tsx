        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <Link href="/company-advertising">
              <Button
                variant="outline"
                className="w-full flex items-center justify-start space-x-4 p-4 h-auto border-2 border-dashed border-orange-300 hover:border-orange-500 hover:bg-orange-50"
              >
                <div className="w-12 h-12 bg-orange-500 rounded-lg flex items-center justify-center">
                  <Megaphone className="w-6 h-6 text-white" />
                </div>
                <div className="text-left">
                  <p className="font-medium text-on-surface">Publicidad</p>
                  <p className="text-sm text-gray-600">Gestionar anuncios promocionales</p>
                </div>
              </Button>
            </Link>
          </CardContent>
